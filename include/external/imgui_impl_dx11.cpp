...
void ImGui_ImplDX11_RenderDrawData(ImDrawData* draw_data)
{
    ...
    struct BACKUP_DX11_STATE
    {
        ...
        ID3D11ClassInstance         *PSInstances[256], *VSInstances[256], *GSInstances[256];   // 256 is max according to *GetShader documentation
    ...
    // Dear ImGui clears HS/DS/CS in SetupRenderState(). The stock 1.89.9
    // backend does not restore them, which can corrupt the state expected by
    // Skyrim render hooks such as Community Shaders. Preserve them explicitly.
