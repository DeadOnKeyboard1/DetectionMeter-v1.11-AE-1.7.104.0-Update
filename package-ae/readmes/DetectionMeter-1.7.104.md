...
1.1.3 excludes active player teammates and their summons, plus player summons
and commanded/reanimated allies. Existing meters are removed when eligibility
changes. Neutral/enemy summons remain eligible. Only the overlay is changed;
the game's stealth AI is untouched. Custom followers without the engine's
teammate flag or allied commander require a mod-specific integration.
Ownership/filter mock tests passed; in-game verification is pending.
